        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-2 text-sm">
            ...
            <div className="flex items-center space-x-3 py-3">
              <a href="https://www.facebook.com/southaustralianfootballernetballersport" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700">
              ...
              <a href="https://www.youtube.com/@SouthAustralianFootballer" target="_blank" rel="noopener noreferrer" className="text-red-600 hover:text-red-700">
            ...
            <div className="hidden md:flex items-center space-x-6 text-gray-700">
              ...
              <a href="#" className="hover:text-blue-500">OUR MAJOR PARTNERS</a>
