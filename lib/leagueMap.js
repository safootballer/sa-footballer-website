export const LEAGUE_MAP = {
  // ── AFL ───────────────────────────────────────────────────────────
  'afl-league': { level1: 'AFL', level2: 'League', level3: 'AFL', sortOrder: 1 },
  ...
  // ── SANFLW ────────────────────────────────────────────────────────
  '63232818': { level1: 'SANFLW', level2: 'League', level3: 'SANFLW League', sortOrder: 1 },

  // ── Amateurs (Men's) — League ─────────────────────────────────────
  '8eecd4b0': { level1: "Amateurs (Men's)", level2: 'League',   level3: 'Division 1', sortOrder: 1 },
  '85247b82': { level1: "Amateurs (Men's)", level2: 'League',   level3: 'Division 2', sortOrder: 2 },
  '372b55e9': { level1: "Amateurs (Men's)", level2: 'League',   level3: 'Division 3', sortOrder: 3 },
  '22794d03': { level1: "Amateurs (Men's)", level2: 'League',   level3: 'Division 4', sortOrder: 4 },
  '372d8776': { level1: "Amateurs (Men's)", level2: 'League',   level3: 'Division 5', sortOrder: 5 },
  '961ce426': { level1: "Amateurs (Men's)", level2: 'League',   level3: 'Division 6', sortOrder: 6 },
  '43b5cc78': { level1: "Amateurs (Men's)", level2: 'League',   level3: 'Division 7', sortOrder: 7 },

  // ── Amateurs (Men's) — Reserves ───────────────────────────────────
  '1f82c881': { level1: "Amateurs (Men's)", level2: 'Reserves', level3: 'Division 1 Reserves', sortOrder: 1 },
  '8ebba3c8': { level1: "Amateurs (Men's)", level2: 'Reserves', level3: 'Division 2 Reserves', sortOrder: 2 },
  'b9156c34': { level1: "Amateurs (Men's)", level2: 'Reserves', level3: 'Division 3 Reserves', sortOrder: 3 },
  '692c9b17': { level1: "Amateurs (Men's)", level2: 'Reserves', level3: 'Division 4 Reserves', sortOrder: 4 },
  'cedbc98d': { level1: "Amateurs (Men's)", level2: 'Reserves', level3: 'Division 5 Reserves', sortOrder: 5 },
  '3beb6a9e': { level1: "Amateurs (Men's)", level2: 'Reserves', level3: 'Division 6 Reserves', sortOrder: 6 },
  '1991ba25': { level1: "Amateurs (Men's)", level2: 'Reserves', level3: 'Division 7 Reserves', sortOrder: 7 },

  // ── Amateurs (Men's) — C-Grade ────────────────────────────────────
  'd7fe9dd5': { level1: "Amateurs (Men's)", level2: 'C-Grade', level3: 'Division C1', sortOrder: 1 },
  'aea638ff': { level1: "Amateurs (Men's)", level2: 'C-Grade', level3: 'Division C2', sortOrder: 2 },
  '256a623b': { level1: "Amateurs (Men's)", level2: 'C-Grade', level3: 'Division C3', sortOrder: 3 },
  '1bd8ff22': { level1: "Amateurs (Men's)", level2: 'C-Grade', level3: 'Division C4', sortOrder: 4 },
  '792996a6': { level1: "Amateurs (Men's)", level2: 'C-Grade', level3: 'Division C5', sortOrder: 5 },
  'a645b2ca': { level1: "Amateurs (Men's)", level2: 'C-Grade', level3: 'Division C6', sortOrder: 6 },
  '69f075a6': { level1: "Amateurs (Men's)", level2: 'C-Grade', level3: 'Division C7', sortOrder: 7 },
  'a374a910': { level1: "Amateurs (Men's)", level2: 'C-Grade', level3: 'Division C8', sortOrder: 8 },

  // ── SAWFL Women's ─────────────────────────────────────────────────
  '012b743d': { level1: "SAWFL Women's", level2: 'League',   level3: 'Division 1',          sortOrder: 1 },
  'c54fb997': { level1: "SAWFL Women's", level2: 'League',   level3: 'Division 2',          sortOrder: 2 },
  '68158f54': { level1: "SAWFL Women's", level2: 'League',   level3: 'Division 3',          sortOrder: 3 },
  'c7355be5': { level1: "SAWFL Women's", level2: 'League',   level3: 'Division 4',          sortOrder: 4 },
  '387394cc': { level1: "SAWFL Women's", level2: 'League',   level3: 'Division 5',          sortOrder: 5 },
  '629dbe72': { level1: "SAWFL Women's", level2: 'League',   level3: 'Division 6',          sortOrder: 6 },
  '56ad9865': { level1: "SAWFL Women's", level2: 'Reserves', level3: 'Division 1 Reserves', sortOrder: 1 },
  '0d9cc3ac': { level1: "SAWFL Women's", level2: 'Reserves', level3: 'Division 2 Reserves', sortOrder: 2 },
...
export const LEVEL2_ORDER = {
  ...
  'SANFLW': ['League'],
  "Amateurs (Men's)": ['League', 'Reserves', 'C-Grade'],
...
export function getLeagueCategory(gradeId) {
  return LEAGUE_MAP[gradeId] ?? { level1: 'Other', level2: 'Other', level3: gradeId, sortOrder: 999 }
}